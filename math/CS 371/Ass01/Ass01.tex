...
In Python, which claims to be IEEE-compliant, the following code:
...
\begin{verbatim}
Commutativity: True
Distributativity: True
Cancellation: True
Square root: True
\end{verbatim}

This is probably due to the Python interpreter doing some internal optimization.
\end{document}  